...
class upsample1d(nn.Module):
    def __init__(self, in_channels, out_channels, kernel_size, scale_factor, bias=False):
        ...
        self.conv = nn.Conv1d(in_channels, out_channels, kernel_size=kernel_size, stride=1,
...
class upsample3d(nn.Module):
    def __init__(self, in_channels, out_channels, kernel_size, scale_factor, bias=False):
        ...
        self.conv = nn.Conv3d(in_channels, out_channels, kernel_size=kernel_size, stride=1,
                              padding=(kernel_size - 1) // 2, bias=bias)
        self.scale_factor = scale_factor
...
class single_decoder(torch.nn.Module):
    def __init__(self, num_stage, current_stage, opx, opx_upper_layer, opy, opxy):
        ...
        self.opx = opx#conv
        self.opx_upper_layer = opx_upper_layer#conv
        self.opy = opy#没有
        self.opxy = opxy#add+relu
...
# model = PlainConvUNet(1, 4, (32, 64, 128, 256), nn.Conv3d, 3, (1, 1, 1, 1), (2, 2, 2, 2), 1,
